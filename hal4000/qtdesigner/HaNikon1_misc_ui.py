...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.light5Button.setGeometry(QtCore.QRect(370, 20, 40, 24))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.light5Button.setText(_translate("Dialog", "All Off", None))
