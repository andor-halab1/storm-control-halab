...
class Ui_Form_Crisp(object):
    def setupUi(self, Form):
        ...
        self.derrText.setGeometry(QtCore.QRect(171, 90, 100, 24))
        self.derrText.setText(_fromUtf8("derr: see MFC LCD"))
        self.derrText.setAlignment(QtCore.Qt.AlignLeft)
        self.derrText.setObjectName(_fromUtf8("derrText"))
        ...
        self.offsetSpinBox.setGeometry(QtCore.QRect(211, 155, 65, 24))
        ...
        self.stateText.setGeometry(QtCore.QRect(171, 195, 40, 24))
        ...
        self.errText.setGeometry(QtCore.QRect(221, 195, 40, 24))
    ...
    def retranslateUi(self, Form):
        ...
        self.calButton3.setText(_translate("Form", "Set Gain and Offset", None))
        self.calButton4.setText(_translate("Form", "Change Offset", None))
        self.calButton5.setText(_translate("Form", "Get Crisp Ready", None))
        self.irButton.setText(_translate("Form", "IR ON", None))

class Ui_Form_Nikon(object):
    def setupUi(self, Form):
        Form.setObjectName(_fromUtf8("Form"))
        Form.resize(298, 249)
        self.statusBox = QtGui.QGroupBox(Form)
        self.statusBox.setGeometry(QtCore.QRect(10, 0, 80, 241))
        self.statusBox.setObjectName(_fromUtf8("statusBox"))
        ...
        self.offsetText.setObjectName(_fromUtf8("offsetText"))
        self.offsetSpinBox = QtGui.QDoubleSpinBox(self.statusBox)
        self.offsetSpinBox.setGeometry(QtCore.QRect(10, 90, 65, 24))
        self.offsetSpinBox.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.offsetSpinBox.setMinimum(-5000.0)
        self.offsetSpinBox.setMaximum(5000.0)
        self.offsetSpinBox.setSingleStep(1)
    ...
    def retranslateUi(self, Form):
        Form.setWindowTitle(_translate("Form", "Form", None))
        self.statusBox.setTitle(_translate("Form", "Nikon PFS", None))
        self.Button1.setText(_translate("Form", "Change", None))
        self.irButton.setText(_translate("Form", "IR ON", None))
